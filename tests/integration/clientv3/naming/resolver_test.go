...
func TestGrpcResolver(t *testing.T) {
	...
	err := endpoints.ManagerAddEndpoint(context.TODO(), em, "foo/e1", e1);
	if err != nil {
  ...
  endpoints.ManagerDeleteEndpoint(context.TODO(), em, "foo/e1")
	endpoints.ManagerAddEndpoint(context.TODO(), em, "foo/e2", e2)
