...
require (
	...
	github.com/ptabor/etcd/api/v3 v3.5.0-alpha.13
	github.com/ptabor/etcd/client/v2 v2.305.0-alpha.13
	github.com/ptabor/etcd/client/v3 v3.5.0-alpha.13
	github.com/ptabor/etcd/etcdctl/v3 v3.5.0-alpha.13
	github.com/ptabor/etcd/pkg/v3 v3.5.0-alpha.13
	github.com/ptabor/etcd/raft/v3 v3.5.0-alpha.13
	github.com/ptabor/etcd/server/v3 v3.5.0-alpha.13
