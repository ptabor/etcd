...
import (
	...
	etcdservergw "github.com/ptabor/etcd/api/v3/etcdserverpb/gw"
	"github.com/ptabor/etcd/client/v3/credentials"
	"github.com/ptabor/etcd/pkg/v3/debugutil"
	"github.com/ptabor/etcd/pkg/v3/httputil"
	"github.com/ptabor/etcd/pkg/v3/transport"
	"github.com/ptabor/etcd/server/v3/etcdserver"
	"github.com/ptabor/etcd/server/v3/etcdserver/api/v3client"
	"github.com/ptabor/etcd/server/v3/etcdserver/api/v3election"
	"github.com/ptabor/etcd/server/v3/etcdserver/api/v3election/v3electionpb"
	v3electiongw "github.com/ptabor/etcd/server/v3/etcdserver/api/v3election/v3electionpb/gw"
	"github.com/ptabor/etcd/server/v3/etcdserver/api/v3lock"
	"github.com/ptabor/etcd/server/v3/etcdserver/api/v3lock/v3lockpb"
	v3lockgw "github.com/ptabor/etcd/server/v3/etcdserver/api/v3lock/v3lockpb/gw"
	"github.com/ptabor/etcd/server/v3/etcdserver/api/v3rpc"
