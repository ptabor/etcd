...
- `github.com/ptabor/etcd` Go packages have moved to `github.com/ptabor/etcd/{api,pkg,raft,client,etcdctl,server,raft,tests}/v3` to follow the [Go modules](https://github.com/golang/go/wiki/Modules) conventions
