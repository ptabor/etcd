...
[![GoDoc](https://godoc.org/github.com/ptabor/etcd/client?status.png)](https://godoc.org/github.com/ptabor/etcd/client)
...
```bash
go get github.com/ptabor/etcd/v3/client
```
...
import (
	...
	"github.com/ptabor/etcd/v3/client"
)
